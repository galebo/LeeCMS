...
@Controller
@RequestMapping("/cfgRelatives*")
public class CfgRelativeController  extends BaseController{

    @RequestMapping(method = RequestMethod.GET)
    public ModelAndView handleRequest(@RequestParam(required = false, value = "q") String query)
    throws Exception {
        return new ModelAndView().addObject(commonService.search(query, CfgRelative.class));
    }
}
