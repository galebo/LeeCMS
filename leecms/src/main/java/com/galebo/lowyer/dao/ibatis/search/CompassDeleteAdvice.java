package com.galebo.lowyer.dao.ibatis.search;
...
/**
 * An extension to Compass Delete Advice that works only wiht {@link com.galebo.lowyer.dao.ibatis.GenericDaoiBatis}
 * class (or sub classes) and uses its {@link com.galebo.lowyer.dao.ibatis.GenericDaoiBatis#getPersistentClass()}
